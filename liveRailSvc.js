...
var findCb = function(conErr, db, req, res) {
    ...
    //get report type
    var reportType = req.query.reportType || 'statistics';
...
var findByIdCb = function(conErr, db, req, res) {
    ...
    //var collectionName = LIVERAIL + pubCode;
    var collectionName = LIVERAIL;

    var id = req.params.id;
    console.log('Retrieving LiveRail report: ' + id);
    db.collection(collectionName, function(err, collection) {
            ...
            if(!err) {
                if(format === 'xml') {
                    ...
                    if(!doc) {
                        ...
                        //remove last rawResponse item
                        doc = removeLastRawResponse( doc );
